...
<div class="pg-card"><img src="https://commons.wikimedia.org/wiki/Special:FilePath/Tempura.JPG" alt="Tempura sushi"/><div class="pg-body"><div class="pg-name">Tempura Sushi</div><div class="pg-serving">12 rolls</div><span class="pg-chip pg-s">2.5 Starch</span><span class="pg-chip pg-p">3 Protein</span><span class="pg-chip pg-f">4 Fat</span></div></div>
<div class="pg-card"><img src="https://commons.wikimedia.org/wiki/Special:FilePath/Hebinome_Sushi.JPG" alt="Sushi"/><div class="pg-body"><div class="pg-name">Sushi</div><div class="pg-serving">12 rolls</div><span class="pg-chip pg-s">2.5 Starch</span><span class="pg-chip pg-p">3 Protein</span><span class="pg-chip pg-f">2 Fat</span></div></div>
<div class="pg-card"><img src="https://commons.wikimedia.org/wiki/Special:FilePath/NCI_Visuals_Food_Hamburger.jpg" alt="Hamburger"/><div class="pg-body"><div class="pg-name">Hamburger</div><div class="pg-serving">1 burger · fat depends on extras</div><span class="pg-chip pg-s">3 Starch</span><span class="pg-chip pg-p">5 Protein</span></div></div>
<div class="pg-card"><img src="https://commons.wikimedia.org/wiki/Special:FilePath/French_Fries.JPG" alt="French fries"/><div class="pg-body"><div class="pg-name">French Fries</div><div class="pg-serving">100 g</div><span class="pg-chip pg-s">1.5 Starch</span><span class="pg-chip pg-f">3 Fat</span></div></div>
</div>
...
<div class="pg-card"><img src="https://commons.wikimedia.org/wiki/Special:FilePath/Tempura.JPG" alt="Sushi tempura"/><div class="pg-body"><div class="pg-name">Sushi Tempura</div><div class="pg-serving">12 rollos</div><span class="pg-chip pg-s">2.5 Almidón</span><span class="pg-chip pg-p">3 Proteína</span><span class="pg-chip pg-f">4 Grasa</span></div></div>
<div class="pg-card"><img src="https://commons.wikimedia.org/wiki/Special:FilePath/Hebinome_Sushi.JPG" alt="Sushi"/><div class="pg-body"><div class="pg-name">Sushi</div><div class="pg-serving">12 rollos</div><span class="pg-chip pg-s">2.5 Almidón</span><span class="pg-chip pg-p">3 Proteína</span><span class="pg-chip pg-f">2 Grasa</span></div></div>
<div class="pg-card"><img src="https://commons.wikimedia.org/wiki/Special:FilePath/NCI_Visuals_Food_Hamburger.jpg" alt="Hamburguesa"/><div class="pg-body"><div class="pg-name">Hamburguesa</div><div class="pg-serving">1 hamburguesa · la grasa depende de los extras</div><span class="pg-chip pg-s">3 Almidón</span><span class="pg-chip pg-p">5 Proteína</span></div></div>
<div class="pg-card"><img src="https://commons.wikimedia.org/wiki/Special:FilePath/French_Fries.JPG" alt="Papas fritas"/><div class="pg-body"><div class="pg-name">Papas Fritas</div><div class="pg-serving">100 g</div><span class="pg-chip pg-s">1.5 Almidón</span><span class="pg-chip pg-f">3 Grasa</span></div></div>
</div>
